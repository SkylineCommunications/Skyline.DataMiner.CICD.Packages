namespace UpdateService_4
{
	...
	internal class ConstructResourceOnlyUpdateSharedSourceDialogTask : Task
	{
		...
		public ConstructResourceOnlyUpdateSharedSourceDialogTask(Helpers helpers, Guid sharedSourceServiceId, IEnumerable<Order> ordersUsingSharedSource, IEnumerable<LockInfo> lockInfos, UserInfo userInfo) : base(helpers)
		{
		...
		{
			EditSharedSourceDialog = new EditSharedSourceDialog(helpers, sharedSourceServiceId, ordersUsingSharedSource, lockInfos, userInfo, UpdateServiceDialogOptions.OnlyResourceChange);
		}
	}
}
