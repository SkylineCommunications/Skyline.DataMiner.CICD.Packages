...
namespace Skyline.DataMiner.DeveloperCommunityLibrary.YLE.Tasks.ServiceTasks
{
	...
	public class UpdateProfileParametersTask : Task
	{
		private readonly Service service;
		private readonly List<Function> functionsToUpdate;

		public UpdateProfileParametersTask(Helpers helpers, Service service, List<Function> functionsToUpdate) : base(helpers)
		{
		...
		{
			if (!helpers.ServiceManager.TryUpdateProfileParameters(service, functionsToUpdate)) throw new ProfileParametersNotUpdatedException(functionsToUpdate);
		}

		public override string Description => "Updating profile parameters";
	}
}
