...
{
    public class OssTransmissionSectionConfiguration : ISectionConfiguration
    {
        ...
        public VideoSectionConfiguration VideoSectionConfiguration { get; private set; } = new VideoSectionConfiguration(YLE.Integrations.Eurovision.Type.OSSTransmission);
