...
{
    public class SatelliteCapacitySectionConfiguration : ISectionConfiguration    
    {
        ...
        public VideoSectionConfiguration VideoSectionConfiguration { get; private set; } = new VideoSectionConfiguration(YLE.Integrations.Eurovision.Type.SatelliteCapacity);
