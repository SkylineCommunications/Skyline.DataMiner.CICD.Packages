namespace Library_1.UI.NonLive.NonIplayProject
{
	...
	public class ProjectSectionConfiguration : ISectionConfiguration
	{
		public ProjectSectionConfiguration(UserInfo userInfo)
		{
