namespace Skyline.DataMiner.DeveloperCommunityLibrary.YLE.Integrations.EVS
{
	...
	public class DeleteRecordingSessionExecutor : MessageExecutor<DeleteRecordingSessionResult>
	{
		public DeleteRecordingSessionExecutor(DeleteRecordingSessionResult message) : base(message)
		{
