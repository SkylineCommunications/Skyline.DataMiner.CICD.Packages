	...
	class Script
	{
		...
		public void Run(Engine engine)
		{
			try
			{
				...
				var helpers = new Helpers(engine, Scripts.SendOrderDebugReport);

				var dialog = new SendOrderDebugReportDialog(helpers);
		...
		private void ShowExceptionDialog(Engine engine, Exception e)
		{
			ExceptionDialog dialog = new ExceptionDialog(engine, e);
