...
namespace LocalBackup_1
{
	...
	{
		private LocalBackupHandler localBackupHandler;
		...
		public void Run(Engine engine)
		{
			try
			{
				...
				helpers = new Helpers(engine, Scripts.LocalBackup);

				localBackupHandler = new LocalBackupHandler(helpers);
				localBackupHandler.GenerateExcelFile();
			}
		...
		protected virtual void Dispose(bool disposing)
		{
			if (!disposedValue)
			{
				if (disposing)
				{
					localBackupHandler.Workbook?.Close();
				}
			}
