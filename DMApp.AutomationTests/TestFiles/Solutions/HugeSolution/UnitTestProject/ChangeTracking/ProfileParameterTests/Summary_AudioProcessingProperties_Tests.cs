namespace UnitTestProject.ChangeTracking.ProfileParameterTests
{
	...
	[TestClass]
	public class Summary_AudioProcessingProperties_Tests
	{
		[TestMethod]
		public void AudioProcessing_NotChanged()
		{
			...
			Assert.IsFalse(((ProfileParameterChangeSummary)profileParameter.Change.Summary).AudioProcessingProfileParametersChanged);
		}

		[TestMethod]
		public void AudioProcessing_Changed()
		{
			var profileParameter = new ProfileParameter
			{
				Name = "this",
			...
			Assert.IsTrue(((ProfileParameterChangeSummary)profileParameter.Change.Summary).AudioProcessingProfileParametersChanged);
		}

		[TestMethod]
		public void AudioProcessing_NotChanged_2()
		{
			var profileParameter = new ProfileParameter
			{
				Name = "this",
			...
			Assert.IsFalse(((ProfileParameterChangeSummary)profileParameter.Change.Summary).NewAudioProcessingNeedsToBeAdded);
		}

		[TestMethod]
		public void AudioProcessing_Changed_2()
		{
			var profileParameter = new ProfileParameter
			{
				Name = "this",
			...
			Assert.IsTrue(((ProfileParameterChangeSummary)profileParameter.Change.Summary).NewAudioProcessingNeedsToBeAdded);
		}

		[TestMethod]
		public void AudioProcessing_NotChanged_3()
		{
			var profileParameter = new ProfileParameter
			{
				Name = "this",
		...
		[TestMethod]
		public void AudioProcessing_Changed_3()
		{
			var profileParameter = new ProfileParameter
			{
				Name = "this",
