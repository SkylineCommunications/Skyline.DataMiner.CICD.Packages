namespace UnitTestProject.ChangeTracking.ProfileParameterTests
{
	...
	[TestClass]
	public class Summary_OtherProperties_Tests
	{
		[TestMethod]
		public void Capability_NotChanged()
		{
		...
		[TestMethod]
		public void Capability_Changed()
		{
			var profileParameter = new ProfileParameter
			{
				Name = "this",
		...
		[TestMethod]
		public void NonCapability_NotChanged()
		{
			var profileParameter = new ProfileParameter
			{
				Name = "this",
				...
				DefaultValue = new ParameterValue { StringValue = "default value" },
				Type = ParameterType.Text,
				Category = ProfileParameterCategory.Monitoring,
			};

			profileParameter.AcceptChanges(null);

			Assert.IsFalse(((ProfileParameterChangeSummary)profileParameter.Change.Summary).OtherProfileParametersChanged);
		}

		[TestMethod]
		public void NonCapability_Changed()
		{
			var profileParameter = new ProfileParameter
			{
				Name = "this",
			...
			Assert.IsTrue(((ProfileParameterChangeSummary)profileParameter.Change.Summary).OtherProfileParametersChanged);
		}
	}
}
